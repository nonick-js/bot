...
const ignoreSetting = [
  // 例外 (タイプ)
  new SelectMenu({
    customId: 'nonick-js:setting-message-expansion-ignore-types',
  ...
  // 例外 (チャンネル)
  new SelectMenu({
    customId: 'nonick-js:setting-message-expansion-ignore-channels',
...
export default [...generalSetting, ...ignoreSetting];