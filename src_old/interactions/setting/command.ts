  ...
  options: [
    {
      ...
      choices: [
        ...
        { name: '自動スレッド作成', value: FeatureType.AutoCreateThread },
      ...
      new ActionRowBuilder<StringSelectMenuBuilder>().setComponents(
        new StringSelectMenuBuilder()
          ...
          .setOptions(
            ...
            { label: '自動スレッド作成', value: FeatureType.AutoCreateThread, description: 'メッセージが送信された際にスレッドを自動で作成', emoji: '🧵' },
...
export default [command, featuresSelect];