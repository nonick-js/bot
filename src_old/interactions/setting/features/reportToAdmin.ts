...
const generalSetting = [
  ...
  new Button({
    ...
    interaction.showModal(channelModal.setCustomId('nonick-js:setting-report-channel-modal'));
  }),
  new Modal({
    customId: 'nonick-js:setting-report-channel-modal',
  }, (interaction) => {
    changeChannelSetting(interaction, 'report.channel', FeatureType.ReportToAdmin);
  }),
];
...
const mentionSetting = [
  ...
  new Button({
    ...
    interaction.showModal(roleModal.setCustomId('nonick-js:setting-report-mention-role-modal'));
  }),
  new Modal({
    customId: 'nonick-js:setting-report-mention-role-modal',
  }, async (interaction) => {
    changeMentionRoleSetting(interaction, 'report.mention.role', FeatureType.ReportToAdmin);
  }),
];

export default [...generalSetting, ...mentionSetting];