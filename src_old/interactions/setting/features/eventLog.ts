...
const timeoutLogSetting = [
  ...
  new Button({
    ...
    interaction.showModal(channelModal.setCustomId('nonick-js:setting-log-timeout-channel-modal'));
  }),
  new Modal({
    customId: 'nonick-js:setting-log-timeout-channel-modal',
  }, (interaction) => {
    changeChannelSetting(interaction, 'log.timeout.channel', FeatureType.EventLog);
  }),
];
...
const kickLogSetting = [
  ...
  new Button({
    ...
    interaction.showModal(channelModal.setCustomId('nonick-js:setting-log-kick-channel-modal'));
  }),
  new Modal({
    customId: 'nonick-js:setting-log-kick-channel-modal',
  }, (interaction) => {
    changeChannelSetting(interaction, 'log.kick.channel', FeatureType.EventLog);
  }),
];
...
const banLogSetting = [
  ...
  new Button({
    ...
    interaction.showModal(channelModal.setCustomId('nonick-js:setting-log-ban-channel-modal'));
  }),
  new Modal({
    customId: 'nonick-js:setting-log-ban-channel-modal',
  }, (interaction) => {
    changeChannelSetting(interaction, 'log.ban.channel', FeatureType.EventLog);
  }),
];
...
const voiceLogSetting = [
  ...
  new Button({
    ...
    interaction.showModal(channelModal.setCustomId('nonick-js:setting-log-voice-channel-modal'));
  }),
  new Modal({
    customId: 'nonick-js:setting-log-voice-channel-modal',
  }, (interaction) => {
    changeChannelSetting(interaction, 'log.voice.channel', FeatureType.EventLog);
  }),
];
...
const deleteLogSetting = [
  ...
  new Button({
    ...
    interaction.showModal(channelModal.setCustomId('nonick-js:setting-log-delete-channel-modal'));
  }),
  new Modal({
    customId: 'nonick-js:setting-log-delete-channel-modal',
  }, (interaction) => {
    changeChannelSetting(interaction, 'log.delete.channel', FeatureType.EventLog);
  }),
];

export default [...timeoutLogSetting, ...kickLogSetting, ...banLogSetting, ...voiceLogSetting, ...deleteLogSetting];