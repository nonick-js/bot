...
module.exports = {
    ...
    exec: async (interaction, client, Configs) => {
        ...
        if (leave) {
            ...
            embed.spliceFields(1, 1, {name: '退室ログ', value: discord.Formatters.formatEmoji('758380151238033419')+' 無効化中', inline:true});
            ...
            embed.spliceFields(1, 1, {name: '退室ログ', value: discord.Formatters.formatEmoji('758380151544217670')+' 有効化中('+discord.Formatters.channelMention(leaveCh)+')', inline:true});
