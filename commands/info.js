...
module.exports = {
    ...
    exec: async (client, interaction, Configs, language) => {
        const embed = new discord.MessageEmbed()
            ...
            .setDescription(language('Info.Embed.Description'))
            .setFooter({ text: `${language('Info.Embed.Fotter.Text')}`, iconURL: 'https://media.discordapp.net/attachments/958791423161954445/975266759529623652/-3.png?width=663&height=663' })
            .setColor('WHITE');
        const button = new discord.MessageActionRow().addComponents(
            new discord.MessageButton()
                .setLabel(language('Info.Button.Label'))
                .setStyle('LINK')
